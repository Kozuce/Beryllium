...
#define TIF_PROC_UMOUNTED      15

#define AS_FLAGS_SUS_PATH       6
#define AS_FLAGS_SUS_MOUNT      7
#define AS_FLAGS_SUS_KSTAT      8
#define AS_FLAGS_OPEN_REDIRECT  9
#define AS_FLAGS_SUS_MAP       10
