...
#ifndef lz4_compress
#define lz4_compress(in, inlen, out, outlen, wrk) \
    LZ4_compress_default(in, out, inlen, *(outlen), wrk)
#endif

#ifndef lz4_decompress_unknownoutputsize
#define lz4_decompress_unknownoutputsize(in, inlen, out, outlen) \
    LZ4_decompress_safe(in, out, inlen, *(outlen))
#endif
